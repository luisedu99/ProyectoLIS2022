    ...
    <div class="flex flex-col flex-1 w-full">
      ...
      <main class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
          ...
          $con = connect();
          $id = $_GET['id'];
          $sql = "SELECT * FROM specialty  WHERE codespe= '$id'";
          $query  = $con->query($sql);
          $data =  array();
          if ($query) {
          ...
          <?php if (count($data) > 0) : ?>
            <?php foreach ($data as $d) : ?>
              <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <form method="POST" autocomplete="off" action="../../folder/specialty.php?id=<?php echo $d->codespe; ?>" role="form">


                  <label class="block text-sm">
                    <span class="text-gray-700 dark:text-gray-400">Nombres</span>
                    <input name="nombrees" value="<?php echo $d->nombrees; ?>" type="text" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-teal-400 focus:outline-none focus:shadow-outline-teal dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Cardiologia" />
                  </label>
                  ...
                  <footer class="flex flex-col items-center justify-end px-3 py-2 -mx-3 -mb-6 space-y-4 sm:space-y-0 sm:space-x-6 sm:flex-row bg-gray-50 dark:bg-gray-800">
                    ...
                    <button name="update1" class="w-full px-5 py-3 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-teal-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 active:bg-teal-600 hover:bg-teal-700 focus:outline-none focus:shadow-outline-teal">
                      Actualizar
                    </button>
                  </footer>
