  ...
  <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
    ...
    <aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
      <div class="py-4 text-gray-500 dark:text-gray-400">
        <a class="ml-6 text-lg font-bold text-gray-800 dark:text-gray-200" href="patiens-mostrar.php">
          Clinical Journal
        </a>
        <ul class="mt-6">
          <li class="relative px-6 py-3">
            <span class="absolute inset-y-0 left-0 w-1 bg-teal-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
            <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="patiens-mostrar.php">
                    ...
                    <?php foreach ($data as $d) : ?>
                      <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3 text-xs">
                          ...
                          if ($d->estado == 1) { ?>
                            <form method="get" action="javascript:activo('<?php echo $d->estado; ?>')">
                          ...
                          <?php  } else { ?>
                            ...
                            <form method="get" action="javascript:inactivo('<?php echo $d->estado; ?>')">
