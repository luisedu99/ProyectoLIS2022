              ...
              <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <form method="POST" autocomplete="off" action="../../folder/appointment.php?id=<?php echo $d->codcit; ?>" role="form">
                  ...
                  <label class="block text-sm">
                    ...
                    <input type="datetime-local" name="start" value="<?php echo $d->end; ?>" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-teal-400 focus:outline-none focus:shadow-outline-teal dark:text-gray-300 dark:focus:shadow-outline-gray form-input" />

                  </label>

                  <label class="block text-sm">
                    <span class="text-gray-700 dark:text-gray-400">Fin</span>
                    <input type="datetime-local" name="end" value="<?php echo $d->start; ?>" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-teal-400 focus:outline-none focus:shadow-outline-teal dark:text-gray-300 dark:focus:shadow-outline-gray form-input" />
                  </label>
                  ...
                  <footer class="flex flex-col items-center justify-end px-3 py-2 -mx-3 -mb-6 space-y-4 sm:space-y-0 sm:space-x-6 sm:flex-row bg-gray-50 dark:bg-gray-800">
                    ...
                    <button name="update6" class="w-full px-5 py-3 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-teal-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 active:bg-teal-600 hover:bg-teal-700 focus:outline-none focus:shadow-outline-teal">
                      Actualizar
                    </button>
                  </footer>
