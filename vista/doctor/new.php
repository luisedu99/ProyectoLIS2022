          ...
          <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <form method="POST" autocomplete="off" enctype="multipart/form-data" role="form">
              ...
              <label class="block text-sm">
                ...
                <input name="nomdoc" type="text" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-teal-400 focus:outline-none focus:shadow-outline-teal dark:text-gray-300 dark:focus:shadow-outline-gray form-input" />
              </label>

              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Apellidos</span>
                <input name="apedoc" type="text" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-teal-400 focus:outline-none focus:shadow-outline-teal dark:text-gray-300 dark:focus:shadow-outline-gray form-input" />
              </label>
              ...
              <div class="mt-4 text-sm">
                ...
                <div class="mt-2">
                  <label class="inline-flex items-center text-gray-600 dark:text-gray-400">
                    <input name="sexo" type="radio" class="text-teal-600 form-radio focus:border-teal-400 focus:outline-none focus:shadow-outline-teal dark:focus:shadow-outline-gray" name="sexo" value="Masculino" />
                    <span class="ml-2">Masculino</span>
                  </label>
                  <label class="inline-flex items-center ml-6 text-gray-600 dark:text-gray-400">
                    <input name="sexo" type="radio" class="text-teal-600 form-radio focus:border-teal-400 focus:outline-none focus:shadow-outline-teal dark:focus:shadow-outline-gray" name="sexo" value="Femenino" />
              ...
              <label class="block text-sm">
                ...
                <input type="date" name="fechanaci" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-teal-400 focus:outline-none focus:shadow-outline-teal dark:text-gray-300 dark:focus:shadow-outline-gray form-input" />
              </label>

              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Correo</span>
                <input name="correo" type="email" required="" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-teal-400 focus:outline-none focus:shadow-outline-teal dark:text-gray-300 dark:focus:shadow-outline-gray form-input" />
              </label>
