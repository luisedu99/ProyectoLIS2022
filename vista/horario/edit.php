        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <main class="h-full overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    ...
                    $con = connect();
                    $id = $_GET['id'];
                    $sql = "SELECT horario.idhora,horario.nomhora, doctor.coddoc, doctor.dnidoc, doctor.nomdoc, doctor.apedoc, doctor.telefo, horario.estado, horario.fere  FROM horario INNER JOIN doctor ON horario.coddoc = doctor.coddoc  WHERE idhora= '$id'";
                    $query  = $con->query($sql);
                    $data =  array();
                    if ($query) {
                            ...
                            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                                <form method="POST" autocomplete="off" action="../../folder/horario.php?id=<?php echo $d->idhora; ?>" role="form">
                                    ...
                                    <label class="block text-sm">
                                        ...
                                        <input name="nomhora" value="<?php echo $d->nomhora; ?>" type="text" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-teal-400 focus:outline-none focus:shadow-outline-teal dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Cardiologia" />
                                    </label>
                                    ...
                                    <label class="block mt-4 text-sm">
                                        ...
                                        <select name="coddoc" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-teal-400 focus:outline-none focus:shadow-outline-teal dark:focus:shadow-outline-gray">
                                    ...
                                    <footer class="flex flex-col items-center justify-end px-3 py-2 -mx-3 -mb-6 space-y-4 sm:space-y-0 sm:space-x-6 sm:flex-row bg-gray-50 dark:bg-gray-800">
                                        ...
                                        <button name="update4" class="w-full px-5 py-3 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-teal-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 active:bg-teal-600 hover:bg-teal-700 focus:outline-none focus:shadow-outline-teal">
                                            Actualizar
                                        </button>
                                    </footer>
